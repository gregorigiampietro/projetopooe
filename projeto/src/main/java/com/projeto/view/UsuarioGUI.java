...
public class UsuarioGUI extends JFrame {
	...
	public UsuarioGUI() {
		...
		btnIncluir.setIcon(new ImageIcon(UsuarioGUI.class.getResource("/com/preojeto/estrutura/imagens/application_form_add.png")));
		...
		btnAlterar.setIcon(new ImageIcon(UsuarioGUI.class.getResource("/com/preojeto/estrutura/imagens/application_form_edit.png")));
		...
		btnExcluir.setIcon(new ImageIcon(UsuarioGUI.class.getResource("/com/preojeto/estrutura/imagens/application_form_delete.png")));
		...
		btnSair.setIcon(new ImageIcon(UsuarioGUI.class.getResource("/com/preojeto/estrutura/imagens/sair.png")));
		...
		checkNome.setIcon(new ImageIcon(UsuarioGUI.class.getResource("/com/preojeto/estrutura/imagens/ok.png")));
		
		checkEmail = new JLabel("");
		checkEmail.setIcon(new ImageIcon(UsuarioGUI.class.getResource("/com/preojeto/estrutura/imagens/ok.png")));
		
		checkSenha = new JLabel("");
		checkSenha.setIcon(new ImageIcon(UsuarioGUI.class.getResource("/com/preojeto/estrutura/imagens/ok.png")));
	...
	private void mudaStatusCheckNome() {
		checkNome.setVisible(true);
		if (status == false ) {
			checkNome.setIcon(new ImageIcon(UsuarioGUI.class.getResource("/com/preojeto/estrutura/imagens/iconFechar.png")));
		} else {
			checkNome.setIcon(new ImageIcon(UsuarioGUI.class.getResource("/com/preojeto/estrutura/imagens/ok.png")));
		}
	}
	...
	private void mudaStatusCheckEmail() {
		checkEmail.setVisible(true);
		if (status == false ) {
			checkEmail.setIcon(new ImageIcon(UsuarioGUI.class.getResource("/com/preojeto/estrutura/imagens/iconFechar.png")));
		} else {
			checkEmail.setIcon(new ImageIcon(UsuarioGUI.class.getResource("/com/preojeto/estrutura/imagens/ok.png")));
		}
	}
	...
	private void mudaStatusCheckSenha() {
		checkSenha.setVisible(true);
		if (status == false ) {
			checkSenha.setIcon(new ImageIcon(UsuarioGUI.class.getResource("/com/preojeto/estrutura/imagens/iconFechar.png")));
		} else {
			checkSenha.setIcon(new ImageIcon(UsuarioGUI.class.getResource("/com/preojeto/estrutura/imagens/ok.png")));
		}
	}
